// lib/widgets/formulario_empleado_mp.dart
...
class _FormularioEmpleadoState extends State<FormularioEmpleado> {
  ...
  // Expresión regular para validar el código de nómina (región.depto.sucursal.número)
    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          ...
          // ── Departamento — DropdownButtonFormField ─────────────────
          ...
          // ── Afiliación IESS — SwitchListTile ────────────────────────
          SwitchListTile(
