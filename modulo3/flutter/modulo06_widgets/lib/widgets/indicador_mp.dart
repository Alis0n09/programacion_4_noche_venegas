...
// Indicador genérico de KPI — en nómina lo usamos para mostrar cifras como
// 'Empleados activos', 'Total planilla' o 'Nóminas con error'.
class Indicador extends StatelessWidget {
  final String label;
  final String valor; // String para mayor flexibilidad: '45', '$12.450', '100%'
  final Color color;
