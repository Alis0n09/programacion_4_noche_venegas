...
import 'package:modulo10_riverpod/screens/pantalla_empleados_mp.dart';
...
// │  2  Paso 2  NotifierProvider + lista de empleados               │
...
void main() {
  runApp(const ProviderScope(child: AppNomina()));
}
...
class _Paso1 extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Empleados registrados')),
      body: Center(
        child: Column(
